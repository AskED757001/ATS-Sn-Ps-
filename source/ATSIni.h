...
protected:
    ...
    {                                
        ...
        s = _T("DATA");
        inimoni::inirw( r,f,s, _T("SnEnabled        "), DATA.SnEnabled     );
        inimoni::inirw( r,f,s, _T("PsEnabled        "), DATA.PsEnabled     );
        inimoni::inirw( r,f,s, _T("PsMaxspeed       "), DATA.PsMaxspeed    );
        inimoni::inirw( r,f,s, _T("Speedmeter       "), DATA.Speedmeter    );
        inimoni::inirw( r,f,s, _T("Psdecelerate     "), DATA.Psdecelerate  );
        inimoni::inirw( r,f,s, _T("BarFullGauge     "), DATA.BarFullGauge  );
        inimoni::inirw( r,f,s, _T("BarFullNumber    "), DATA.BarFullNumber );
        inimoni::inirw( r,f,s, _T("SnSpeedTimer     "), DATA.SnSpeedTimer  );
